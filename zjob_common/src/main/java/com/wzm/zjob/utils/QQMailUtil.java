...
public class QQMailUtil {
    public static void QQmail(String subject,String receiver,String context)throws Exception{
        // 配置发送邮件的环境属性
        ...
        // 发件人的账号
        props.put("mail.user", "1578082370@qq.com");
        // 访问SMTP服务时需要提供的密码
        props.put("mail.password", "gjlhexsyhttofede");
