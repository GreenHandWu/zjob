    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#news-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/news/findAllByPage");
            });
            $("#company-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/company/findAllByPage");
            });
            $("#user-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/user/findAllByPage");
            });
            $("#manager-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/sysuser/findAllByPage");
            });
            $("#product-set").click(function () {
                $("#frame-id").attr("src", "${pageContext.request.contextPath}/backend/product/findAllByPage");
            });
        ...
        function loginOut() {
            $.ajax({
                method: 'post',
                url: '${pageContext.request.contextPath}/backend/sysuser/loginOut',
                success: function () {
                    alert('你已退出该系统');
                    //返回登录页重新登录
    ...
    <div class="content-cc">
        ...
        <div class="clear-bottom head">
            <div class="container head-cc">
                <p>ZJOB招聘<span>后台管理系统</span></p>
                <div class="welcome">
                    <div class="left">欢迎您：</div>
                    <div class="right">${sysuser.loginName}</div>
                ...
                <div class="col-xs-2 user-wrap">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item active" name="userSet" id="news-set" style="cursor: pointer">
                            <i class="glyphicon glyphicon-envelope"></i> &nbsp;新闻管理
                        </li>
                        ...
                        <li class="list-group-item" name="companySet" id="company-set" style="cursor: pointer">
                            <i class="glyphicon glyphicon-th-list"></i> &nbsp;企业用户管理
                        </li>
                        ...
                        <li class="list-group-item" name="productSet" id="product-set" style="cursor: pointer">
                            <i class="glyphicon glyphicon-wrench"></i> &nbsp;产品管理
                        </li>
                        <li class="list-group-item" name="orderSet" id="order-set" style="cursor: pointer">
                            <i class="glyphicon glyphicon-book"></i> &nbsp;订单查看
                        </li>
                        <li class="list-group-item" name="positionSet" id="position-set" style="cursor: pointer">
                            <i class="glyphicon glyphicon-certificate"></i> &nbsp;职位管理
                        </li>
                    </ul>
                </div>
